...
\newcommand{\mySectionLeader}{Castellano}
...
\begin{document}
%
\firstpageheader{\bfseries \myCourseNumber \\ \mySectionTime \\ \mySectionLeader}{\bfseries Homework \myHmwkNumber \\ \scriptsize\mySource}{\bfseries \myName \\ \myID \\ \myProfessor}
%
