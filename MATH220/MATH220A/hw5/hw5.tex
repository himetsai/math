...
\begin{homeworkProblem}
	...
	\begin{proof}
		...
		Notice that $G$ is maximal in $\C$, as any larger set would contain points where $Log(1 - z^2)$
		is undefined. Since $f, g$ are compositions of analytic functions, they are analytic.
	\end{proof}
\end{homeworkProblem}
