...
\begin{homeworkProblem}
	...
	\begin{proof}
		...
		\] 	
		Put $b_0 = a_1$, $b_k = a_{2k} + a_{2k + 1} = (-1)^{k}\left(\frac{1}{2k} + \frac{1}{2k + 1}\right)$ for $k \geq 1$. Then
		$\sum_{n = 1}^{\infty} a_n = \sum_{k = 0}^{\infty} b_k$. But then $|b_k|$ decreases
		monotonically and $\lim b_k = 0$, so the series converges by the alternating test.
	\end{proof}
\end{homeworkProblem}
