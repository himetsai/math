...
\begin{homeworkProblem}
	\begin{enumerate}[(a)]
		...
		\begin{proof}
			...
			\]
			for all $r \in (0, 1)$. Since $\sum_{n = 0}^{N - 1} S_n = M$ for some constant $M$, pick $r <
...
\begin{homeworkProblem}
	...
	\begin{proof}
		Note that the $n$th derivative of $\log z$ is $(-1)^{n + 1}(n - 1)!z^{-n}$. Let $a_n =
		\frac{(-1)^{n + 1}}{n}i^{-n}$. Then the power series expansion of $\log z$ about $z = i$ is
		\[
