...
\begin{homeworkProblem}
  ...
  \begin{proof}
    ...
    sequence of polynomials $\{p_n\}$ on $[0, 1]$ such that $p_n \to f$ uniformly. Since $p_n'$ is
    continuous on a compact set, $\sup_{x \in [a, b]} |p_n'(x)| < \infty$. Put $M_n = 2\sup_{x \in
    [a, b]} |p_n'(x)|$ and we have
    \[
      |p_n(x) - p_n(y)| < M_n|x - y|
    \]
