...
\begin{homeworkProblem}
	...
	\begin{proof}
		Suppose $f$ has no zeros in $\overline{B}_1(0)$. Then by the exercise in the start of this assignment, $f = c$ with $|c| = 1$. Suppose $f(z_0) = 0$ for some $z_0 \in \overline{B}_1(0)$. 
	\end{proof}
\end{homeworkProblem}
