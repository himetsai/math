...
\begin{homeworkProblem}
  ...
  \begin{proof}
    ...
    the resulting spanning tree $T$ contains the edge $\{v_3, v_4\}$. Since the resulting spanning
    tree has $3$ edges with an edges of weight $2$, the total cost of $T$ is $4$. But then $\{\{2,
    v_i\}: i \neq 2\} \subset E$ spans $G$ with a total weight of $3$, as it only uses edges of
    weight 1.
  \end{proof}
\end{homeworkProblem}
