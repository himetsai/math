  ...
  \begin{enumerate}[(a)]
    ...
    \begin{proof}
      ...
      \begin{gather*}
        ...
        \end{bmatrix}.
      \end{gather*}
      Thus, the critical points are $x^* = (0, 0)$ or $\pm(2^{-1/8}, 2^{-3/8})$. We can then
      check
      \begin{gather*}
      ...
      $\det \nabla^2 f(2^{-1/8}, 2^{-3/8}) = \det \nabla^2 f(-2^{-1/8}, -2^{-3/8}) = 128 > 0$ and
      $\frac{\partial^2 f}{\partial x_1^2} > 0$, the critical points $\pm (2^{-1/8}, 2^{-3/8})$
      are local minima.
    \end{proof}
    ...
    \begin{proof}
      ...
      f(\vec{x}) \prec 0$ and the critical point is a local maximum.
    \end{proof}
  \end{enumerate}
\end{homeworkProblem}
...
\begin{homeworkProblem}
  ...
  \begin{enumerate}[(a)]
    ...
    \begin{proof}
      ...
      \end{gather*}
      Since $x_ix_i^T \succeq 0$, $\frac{y_i^2 e^{-\langle w, x_i \rangle y_i}}{(1 + e^{-\langle w,
      x_i \rangle y_i})^2} \geq 0$, and the sum of positive semidefinite matrices is positive
...
\begin{homeworkProblem}
  ...
  \begin{enumerate}[(a)]
    ...
    \begin{proof}[Solution]
      ...
      points, on average each point is only off by $f(\mathbf{a})/N \approx 0.0004641$, which is a
      small enough number to me. Given that $\Delta f(\mathbf{a}) \approx 0$, I believe $\mathbf{a}$
      has reached a local minimum up to some computational error. Since  $f$ is convex, $\mathbf{a}$
      is extremely close to the theoretical optimal solution.
    \end{proof}
  \end{enumerate}
