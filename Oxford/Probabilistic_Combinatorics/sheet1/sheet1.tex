...
\begin{homeworkProblem}
  ...
  \begin{proof}
    ...
    \[
      \E[Z] = \E[X] - \E[R] \geq pn^2 - \frac{n^{2r}p^{r^2}}{r!^2}.
    \]
...
\begin{homeworkProblem}
  ...
  \begin{proof}    
    ...
    \begin{align*}
      ...
      &= \E[X] + n(n - 1) (1 - p)^{2n - 3} \\
      &\sim \E[X] + \E[X]^2 \cdot (1 - p)^{-1}.
    \end{align*}
    But then since $f(n) \to -\infty$ and $|f(n)| \leq \log n$, we have $p \to 0$. It follows that $\E[X] \to \infty$, and so
    \[
      \frac{\E[X^2]}{\E[X]^2} \sim \frac{1}{\E[X]} + (1 - p)^{-1} \to 1.
    \]
  ...
  Let $S_{n,p}$ be a random subset of $\{1, 2, \dots, n\}$ chosen by including each element independently with probability $p$.
    ...
    \begin{enumerate}[(a)]
      ...
      \begin{proof}
        ...
        \[
          \E[X] = \sum_{A \text{is $k$-AP}} p^k = \frac{n(n - 1)p^k}{2(k - 1)} = p^k\Theta(n^2) \to 0.
        \]
