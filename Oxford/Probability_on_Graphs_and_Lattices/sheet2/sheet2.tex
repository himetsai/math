...
\begin{homeworkProblem}
  ...
  \begin{enumerate}[(a)]
    ...
    \begin{proof}
      Note that $(D_n)$ is a simple random walk on $\Z_{\geq 0}$ with up probability $\frac{2}{3}$, down probability $\frac{1}{3}$, and reflection at $0$. Put $q = \prob(\text{SRW hits 1}\mid D_0 = 2)$. Then, 
      \[
        \theta = \frac{2}{3}q, \quad \text{and} \quad q = \frac{1}{3} + \frac{2}{3}\prob(\text{SRW hits 1}\mid D_0 = 3).
      \]
      But then by the strong Markov property and translation invariance,
      \[
        \prob(\text{SRW hits 1}\mid D_0 = 3) = \prob(\text{SRW hits 2}\mid D_0 = 3) \cdot \prob(\text{SRW hits 1}\mid D_0 = 2) = q^2.
      \]
      Thus, $q = \frac{1}{3} + \frac{2}{3}q^2$, which has the solution $\frac{1}{2}$. Thus by translation invariance, 
      \[
        \mathbb{P}(D_k > m \text{ for all } k \ge 1 \mid D_0 = m) = \theta = \frac{1}{3}.
      \]
    \end{proof}
    ...
    \]
    \begin{proof}
      Let $\beta$ be the other child of $\rho$. Let $(X_k)_{k \geq 0}$ be the SRW on $\mathbb{T}_n$, and let $\tau_n = \inf\{k \geq 0 : D_k = n\}$. Then by the strong Markov property and translation invariance,
      \[
        \prob(\text{SRW hits } w_n \text{ before } \alpha \mid X_0 = \rho) = \prob(X_1 = \beta \mid X_0 = \rho) \cdot \prob(\text{SRW doesn't hit } \alpha \text{ before }\tau_{n + 1} \mid X_0 = \beta) \geq \frac{1}{2}\theta.
      \]
      The result now follows by taking $\liminf$ as $n \to \infty$.
    \end{proof}
    ...
    \begin{proof}
      By (a) we have
      \[
      \mathbb{P}(\text{SRW on } \mathbb{T}_n^W \text{ started from } \alpha \text{ hits } w_n \text{ before } \rho) \geq \frac{1}{3}.
      \]
      ...
      \[
        \liminf_{n \to \infty} \prob(\{\rho, \alpha\} \notin E(\mathbb{T}_n^W)) > 0.
      \]
