...
\begin{homeworkProblem}
  ...
  \begin{enumerate}[(a)]
    ...
    \begin{proof}
      ...
      \[
        |L \backslash A| = |L| - |A| = (2n)! - \sum_{k = 1}^{n} (-1)^{k - 1}\binom{n}{k}(2n - k)!2^{k} = (2n)! - \sum_{k = 0}^{n} (-1)^{k}\binom{n}{k}(2n - k)!2^{k}.
      \]
    \end{proof}
    ...
    \begin{proof} 
      ...
      to their spouse is
      \[
        |L \backslash A| = \frac{1}{2n} \cdot (2n)! - \sum_{k = 1}^{n} (-1)^{k - 1}\binom{n}{k}(2n - k - 1)!2^{k} = (2n - 1)! - \sum_{k = 0}^{n} (-1)^{k}\binom{n}{k}(2n - k - 1)!2^{k}.
      \]
    \end{proof}
  \end{enumerate}
\end{homeworkProblem}
