...
\begin{description}
  \item[Question 1] Write a short paragraph (3-5 sentences) explaining what you think probability is. 
  
    Probability is a way of measuring how likely something is to happen. It can be expressed as a number between 0 and 1, where 0 means impossible and 1 means certain. The main use of probability is to help us make decisions based on uncertain events.
\end{description}
